...
@section('title') Редактировать паркет @endsection
    ...
    <div class="container">
        <section id="recommendations" class="section">
            <div class="section-title">
                <h1>Редактировать паркет</h1>
            </div>
            <div class="section-content">
                <form method="post" action="{{ route('parquet.update', $parquet) }}" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="form-group">
                        <label for="name" class="form-label">
                            ...
                            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror"
                                   name="name" placeholder="Название" value="{{ $parquet->name }}"
                                   required autofocus>
                    ...
                    <div class="form-group">
                        <label for="type" class="form-label">
                            <input id="type" type="text" placeholder="Тип"
                                   ...
                                   name="type" required value="{{ $parquet->type }}">
                    ...
                    <div class="form-group">
                        <label for="tree" class="form-label">
                            ...
                            <input id="tree" type="text" class="form-control @error('tree') is-invalid @enderror"
                                   name="tree" placeholder="Порода дерева" value="{{ $parquet->tree }}"
                                   required >
                    ...
                    <div class="form-group">
                        <label for="covering" class="form-label">
                            ...
                            <input id="covering" type="text" class="form-control @error('covering') is-invalid @enderror"
                                   name="covering" placeholder="Покрытие" value="{{ $parquet->covering }}"
                                   required >
                    ...
                    <div class="form-group">
                        <label for="price" class="form-label">
                            ...
                            <input id="price" type="number" class="form-control @error('price') is-invalid @enderror"
                                   name="price" placeholder="Цена" value="{{ $parquet->price }}"
                    ...
                    <div class="form-group">
                        <label for="description" class="form-label">
                            <textarea name="description" id="description" class="form-control"
                                      placeholder="Описание">{{ $parquet->description }}</textarea>
                            @error('description')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group">
                        <label for="thickness" class="form-label">
                            ...
                            <input id="thickness" type="number" class="form-control @error('thickness') is-invalid @enderror"
                                   name="thickness" placeholder="Толщина, мм" min="1" value="{{ $parquet->thickness }}"
                                   required>
                    ...
                    <div class="form-group">
                        <label for="width" class="form-label">
                            ...
                            <input id="width" type="number" class="form-control @error('width') is-invalid @enderror"
                                   name="width" placeholder="Ширина, мм" min="1" value="{{ $parquet->width }}"
                                   required>
                    ...
                    <div class="form-group">
                        <label for="length" class="form-label">
                            ...
                            <input id="length" type="number" class="form-control @error('length') is-invalid @enderror"
                                   name="length" placeholder="Длина, мм" min="1" value="{{ $parquet->length }}"
                                   required>
