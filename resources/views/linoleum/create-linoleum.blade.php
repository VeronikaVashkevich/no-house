...
@section('title') Добавить линолеум @endsection
    ...
    <div class="container">
        <section id="recommendations" class="section">
            <div class="section-title">
                <h1>Добавить линолеум</h1>
            </div>
            <div class="section-content">
                <form method="POST" action="{{ route('linoleum.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        <label for="base" class="form-label">
                            ...
                            <input id="base" type="text" class="form-control @error('base') is-invalid @enderror"
                                   name="base" placeholder="Основа (подложка)"
                                   required>
                    ...
                    <div class="form-group">
                        <label for="length" class="form-label">
                            ...
                            <input id="length" type="number" class="form-control @error('length') is-invalid @enderror"
                                   name="length" placeholder="Длина рулона, м" min="1"
                                   required>
