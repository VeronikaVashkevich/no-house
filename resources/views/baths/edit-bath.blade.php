...
@section('title') Редактировать ванну @endsection
    ...
    <div class="container">
        <section id="recommendations" class="section">
            <div class="section-title">
                <h1>Редактировать ванну</h1>
            </div>
            <div class="section-content">
                <form method="post" action="{{ route('baths.update', $bath) }}" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="form-group">
                        <label for="name" class="form-label">
                            ...
                            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror"
                                   name="name" placeholder="Название" value="{{ $bath->name }}"
                                   required autofocus>
                    ...
                    <div class="form-group">
                        <label for="material" class="form-label">
                            <input id="material" type="text" placeholder="Материал"
                                   ...
                                   name="material" required value="{{ $bath->material }}">
                    ...
                    <div class="form-group">
                        <label for="form" class="form-label">
                            ...
                            <input id="form" type="text" class="form-control @error('form') is-invalid @enderror"
                                   name="form" placeholder="Форма" value="{{ $bath->form }}"
                                   required >
                    ...
                    <div class="form-group">
                        <label for="color" class="form-label">
                            ...
                            <input id="color" type="text" class="form-control @error('color') is-invalid @enderror"
                                   name="color" placeholder="Цвет" value="{{ $bath->color }}"
                                   required >
                    ...
                    <div class="form-group">
                        <label for="price" class="form-label">
                            ...
                            <input id="price" type="number" class="form-control @error('price') is-invalid @enderror"
                                   name="price" placeholder="Цена" value="{{ $bath->price }}"
                    ...
                    <div class="form-group">
                        <label for="montageType" class="form-label">
                            ...
                            <input id="montageType" type="text" class="form-control @error('montageType') is-invalid @enderror"
                                   ...
                                   required value="{{ $bath->montageType }}">
                    ...
                    <div class="form-group">
                        <label for="description" class="form-label">
                            <textarea name="description" id="description" class="form-control"
                                      placeholder="Описание">{{ $bath->description }}</textarea>
                            @error('description')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
