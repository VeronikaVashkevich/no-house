...
@section('title') Добавить краску (эмаль) @endsection
    ...
    <div class="container">
        <section id="recommendations" class="section">
            <div class="section-title">
                <h1>Добавить краску (эмаль)</h1>
            </div>
            <div class="section-content">
                <form method="POST" action="{{ route('paint.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        <label for="type" class="form-label">
                            <select name="type" id="type" class="form-control">
                                <option value="dye">Краска</option>
                                <option value="enamel">Эмаль</option>
                            </select>
